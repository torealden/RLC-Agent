...
RELEASE_SCHEDULES: Dict[str, CollectorSchedule] = {
    ...
    'census_trade': CollectorSchedule(
        ...
        collector_class='CensusTradeCollectorV2',
        release_schedule=ReleaseSchedule(
            frequency=ReleaseFrequency.MONTHLY,
            day_of_month=6,  # Variable - see CENSUS_RELEASE_DATES for exact dates
            release_time=time(8, 30),  # 8:30 AM ET per Census schedule
            lag_days=35,  # ~5-6 week lag from reference month
            description="US Census International Trade Monthly (FT900 release)"
        ),
        priority=3,
        commodities=['all'],
    ),
...
# =============================================================================
# CENSUS FT900 RELEASE DATES 2025-2026
# =============================================================================
# Source: https://www.census.gov/foreign-trade/schedule.html
# All releases at 8:30 AM Eastern

CENSUS_RELEASE_DATES = {
    # 2025 releases
    '2024-11': '2025-01-07',  # November 2024 data released Jan 7, 2025
    '2024-12': '2025-02-05',  # December 2024 data released Feb 5, 2025
    '2025-01': '2025-03-06',  # January 2025 data released Mar 6, 2025
    '2025-02': '2025-04-03',  # February 2025 data released Apr 3, 2025
    '2025-03': '2025-05-06',  # March 2025 data released May 6, 2025
    '2025-04': '2025-06-05',  # April 2025 data released Jun 5, 2025
    '2025-05': '2025-07-03',  # May 2025 data released Jul 3, 2025
    '2025-06': '2025-08-05',  # June 2025 data released Aug 5, 2025
    '2025-07': '2025-09-04',  # July 2025 data released Sep 4, 2025
    '2025-08': '2025-11-19',  # August 2025 data released Nov 19, 2025 (delayed)
    '2025-09': '2025-12-11',  # September 2025 data released Dec 11, 2025
    # 2026 releases
    '2025-10': '2026-01-08',  # October 2025 data released Jan 8, 2026
    '2025-11': '2026-01-29',  # November 2025 data released Jan 29, 2026
    '2025-12': '2026-02-19',  # December 2025 data released Feb 19, 2026 (rescheduled)
}


def get_census_release_date(reference_month: str) -> Optional[str]:
    """
    Get the Census release date for a reference month.

    Args:
        reference_month: Format 'YYYY-MM' (e.g., '2025-10')

    Returns:
        Release date as 'YYYY-MM-DD' or None if not in schedule
    """
    return CENSUS_RELEASE_DATES.get(reference_month)


def get_next_census_release(after: date = None) -> Optional[Dict]:
    """
    Get the next Census trade data release.

    Returns:
        Dict with 'reference_month', 'release_date', and datetime objects
    """
    ...
    for ref_month, release_str in sorted(CENSUS_RELEASE_DATES.items()):
        ...
        if release_date > after:
            return {
                'reference_month': ref_month,
                'release_date': release_str,
                'release_datetime': datetime.combine(release_date, time(8, 30)),
            }
    return None
