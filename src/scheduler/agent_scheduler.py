...
OTHER_SCHEDULES = {
    ...
    "fas_psd": {
        "name": "FAS PSD Balance Sheet",
        "schedule": "monthly",
        "day": 15,  # Run on 15th of each month (after WASDE release)
        "time": "08:00",
        "timezone": "America/New_York",
        "agent": "fas_psd_collector",
        "agent_path": "src/agents/collectors/us/usda_fas_collector.py",
        "agent_args": ["collect_psd", "--save-to-db"],
        "description": "Monthly collection of USDA FAS Production, Supply & Distribution data for global S&D tracking"
    },
    "fas_export_sales": {
        "name": "FAS Export Sales Report",
        "schedule": "friday",  # Weekly on Friday after Export Sales Thursday release
        "time": "09:00",
        "timezone": "America/New_York",
        "agent": "fas_esr_collector",
        "agent_path": "src/agents/collectors/us/usda_fas_collector.py",
        "agent_args": ["collect_esr", "--save-to-db"],
        "description": "Weekly FAS export sales data collection for US grain/oilseed exports"
    },
    "crop_map_update": {
        "name": "Crop Production Map Update",
        "schedule": "annual",
        "month": 10,  # October - after main harvest estimates
        "day": 15,    # Mid-month
        "time": "06:00",
        "timezone": "America/New_York",
        "agent": "crop_map_updater",
        "agent_path": "scripts/update_crop_maps.py",
        "agent_args": ["--all", "--archive"],
        "description": "Annual refresh of USDA FAS crop production maps with archiving"
    },
    "ndvi_charts": {
        "name": "NDVI Vegetation Charts",
        "schedule": "weekly",
        "day_of_week": "monday",  # Weekly on Monday
        "time": "07:00",
        "timezone": "America/New_York",
        "agent": "ndvi_collector",
        "agent_path": "src/agents/collectors/global/ndvi_collector.py",
        "agent_args": ["charts", "--all", "--types", "ndvi", "--save-db"],
        "description": "Weekly NDVI vegetation charts from USDA Crop Explorer for crop health monitoring"
    },
    "gfs_forecast": {
        "name": "GFS Weather Forecast",
        "schedule": "daily",
        "time": "06:30",  # After 00Z model run is fully available
        "timezone": "America/New_York",
        "agent": "gfs_collector",
        "agent_path": "src/agents/collectors/global/gfs_forecast_collector.py",
        "agent_args": ["collect", "--latest", "--save-db"],
        "description": "Daily GFS 16-day forecast aggregated to crop regions for yield prediction"
    },
    # ==========================================================================
    # NASS Processing Reports (Monthly)
    # ==========================================================================
    "nass_fats_oils": {
        "name": "NASS Fats & Oils Report",
        "schedule": "monthly",
        "day": 5,  # ~3rd business day of month
        "time": "15:00",  # After 3pm ET release
        "timezone": "America/New_York",
        "agent": "nass_processing_collector",
        "agent_path": "src/agents/collectors/us/nass_processing_collector.py",
        "agent_args": ["fats_oils", "--save-db"],
        "description": "Monthly soybean/vegetable oil production and stocks from NASS Fats & Oils report"
    },
    "nass_grain_crushings": {
        "name": "NASS Grain Crushings Report",
        "schedule": "monthly",
        "day": 3,  # ~1st business day of month
        "time": "15:00",  # After 3pm ET release
        "timezone": "America/New_York",
        "agent": "nass_processing_collector",
        "agent_path": "src/agents/collectors/us/nass_processing_collector.py",
        "agent_args": ["grain_crushings", "--save-db"],
        "description": "Monthly corn/sorghum usage for ethanol and milling from NASS Grain Crushings report"
    },
    "nass_flour_milling": {
        "name": "NASS Flour Milling Report",
        "schedule": "monthly",
        "day": 3,  # ~1st business day of month
        "time": "15:00",  # After 3pm ET release
        "timezone": "America/New_York",
        "agent": "nass_processing_collector",
        "agent_path": "src/agents/collectors/us/nass_processing_collector.py",
        "agent_args": ["flour_milling", "--save-db"],
        "description": "Monthly/quarterly wheat flour production by class from NASS Flour Milling report"
    },
    "nass_peanut_processing": {
        "name": "NASS Peanut Stocks and Processing Report",
        "schedule": "monthly",
        ...
        "agent": "nass_processing_collector",
        "agent_path": "src/agents/collectors/us/nass_processing_collector.py",
        "agent_args": ["peanut_processing", "--save-db"],
        "description": "Monthly peanut milling, crushing, stocks, and usage from NASS Peanut Stocks report"
    },
    # ==========================================================================
    # Census Bureau Trade Pipeline (Monthly)
    # ==========================================================================
    # Census releases trade data around the 6th of the month for 2 months prior
    # Pipeline: Bronze Collect -> Bronze Verify -> Silver Transform -> Silver Verify
    #           -> Gold Views -> Gold Verify -> Log Reader -> Email Summary
    "census_bronze_collector": {
        "name": "Census Bronze Collector",
        "schedule": "monthly",
        "day": 7,  # ~7th of month after Census data release (~6th)
        "time": "08:30",
        "timezone": "America/New_York",
        "agent": "census_bronze_collector",
        "agent_path": "src/agents/collectors/us/census_bronze_collector_agent.py",
        "agent_args": [],
        "description": "Collect Census Bureau trade data and save to bronze layer"
    },
    "census_bronze_verification": {
        "name": "Census Bronze Verification",
        "schedule": "monthly",
        "day": 7,
        "time": "09:00",  # Run 30 min after collector
        "timezone": "America/New_York",
        "agent": "census_bronze_verification",
        "agent_path": "src/agents/verification/census_bronze_verification_agent.py",
        "agent_args": [],
        "description": "Verify Census bronze layer data accuracy"
    },
    "census_silver_transform": {
        "name": "Census Silver Transform",
        "schedule": "monthly",
        "day": 7,
        "time": "09:30",  # Run after bronze verification
        "timezone": "America/New_York",
        "agent": "census_silver_transform",
        "agent_path": "src/agents/transformation/census_silver_transform_agent.py",
        "agent_args": [],
        "description": "Transform Census data to silver layer with unit conversions"
    },
    "census_silver_verification": {
        "name": "Census Silver Verification",
        "schedule": "monthly",
        "day": 7,
        "time": "10:00",  # Run after silver transform
        "timezone": "America/New_York",
        "agent": "census_silver_verification",
        "agent_path": "src/agents/verification/census_silver_verification_agent.py",
        "agent_args": [],
        "description": "Verify Census silver layer unit standards"
    },
    "census_gold_view": {
        "name": "Census Gold Views",
        "schedule": "monthly",
        "day": 7,
        "time": "10:30",  # Run after silver verification
        "timezone": "America/New_York",
        "agent": "census_gold_view",
        "agent_path": "src/agents/gold/census_gold_view_agent.py",
        "agent_args": [],
        "description": "Create/refresh Census trade Gold layer views"
    },
    "census_gold_verification": {
        "name": "Census Gold Verification",
        "schedule": "monthly",
        "day": 7,
        "time": "11:00",  # Run after gold views
        "timezone": "America/New_York",
        "agent": "census_gold_verification",
        "agent_path": "src/agents/verification/census_gold_verification_agent.py",
        "agent_args": [],
        "description": "Verify Census gold layer against bronze/silver"
    },
    "census_log_reader": {
        "name": "Census Log Reader",
        "schedule": "daily",
        "time": "07:00",  # Run daily in morning
        "timezone": "America/New_York",
        "agent": "census_log_reader",
        "agent_path": "src/agents/monitoring/census_log_reader_agent.py",
        "agent_args": [],
        "description": "Read Census pipeline logs and generate daily summary"
    },
    "census_email_summary": {
        "name": "Census Email Summary",
        "schedule": "daily",
        "time": "07:30",  # Run after log reader
        "timezone": "America/New_York",
        "agent": "census_email_summary",
        "agent_path": "src/agents/integration/census_email_summary_agent.py",
        "agent_args": [],
        "description": "Send Census pipeline summary email if issues detected"
    }
}
...
class AgentRunner:
    ...
    def run_agent(self, agent_name: str, agent_path: str = None, agent_args: List[str] = None, **kwargs) -> dict:
        ...
        try:
            ...
            if agent_path:
                ...
                rlc_agent_home = Path(__file__).parent.parent  # src -> RLC-Agent
                ...
                search_paths = [
                    ...
                    Path(__file__).parent / "agents" / f"{agent_name}.py",  # scheduler/agents/
                ]
            ...
            if agent_path is None:
                ...
                # Execute the agent with optional arguments
                cmd = [sys.executable, str(agent_path)] + agent_args
                proc = subprocess.run(
                    cmd,
                    capture_output=True,
                    text=True,
                    timeout=600,  # 10 minute timeout for data collection
...
class RLCScheduler:
    ...
    def _add_schedule(self, schedule_id: str, config: dict):
        ...
        job_func = lambda a=agent_name, p=agent_path, args=agent_args: self.runner.run_agent(a, agent_path=p, agent_args=args)
